...
<body>
    ...
    <table>
        ...
        <%
            String folderPath = application.getRealPath("uploads1");
            ...
            if (files != null && files.length > 0) {
                for (File file : files) {
                    if (file.isFile()) {
                        ...
                        String fileURL = request.getContextPath() + "/uploads1/" + fileName;
        %>
        <tr>
            <td><%= fileName %></td>
        ...
        %>
        <tr>
            <td colspan="2" class="no-materials">No materials available.</td>
        </tr>
        <%
            }
        %>
